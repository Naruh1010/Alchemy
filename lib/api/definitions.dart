...
class Track {
  ...
  factory Track.fromPipeJson(Map<dynamic, dynamic> json, {bool? favorite}) {
    return Track(
      ...
      album: Album(
          id: json['album']?['id'], title: json['album']?['displayTitle']),
      image:
          ImageDetails.fromPrivateString(json['album']?['cover']?['md5'] ?? ''),
